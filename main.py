...
from tools import relationshiphelpers
from load_yml import load_file
from tools.relationshiphelpers import get_srcs

if __name__ == '__main__':
    # 1. classification and format mitre att&ck source data
    #    column: id, type, attack_id, attack_name, attack_description
    # techniques = attack_classification.classify_by_level1('enterprise')  # ranges: pre/enterprise/mobile/ics
    # attack_list = attack_classification.format_by_level3(techniques)
    # print(attack_list)

    get_srcs()
    # mitigation_mitigates_techniques(get_srcs())
