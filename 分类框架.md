...
当然以下提到的分类框架是站在巨人的肩膀上：基于已有 json 元数据源 + stix2, pandas 工具实现的，所以以下说明未进行细节的技术阐述，仅仅站在抽象层面提供一份人人都可以理解的分类框架
...
flowchart RL
	...
	classDef orange fill:#f96,stroke:#333,stroke-width:4px
	class C,G,H,K,P orange
```

注：pre-attack 没有 x_mitre_domains，明明有 attack-pattern 的 json 文件

![image-20221018101335613](C:\Users\19686\AppData\Roaming\Typora\typora-user-images\image-20221018101335613.png)
